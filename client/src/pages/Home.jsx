          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-lg text-gray-600 leading-8">
                ...
                recommendations, analyze transactions, and leverage Generative
                AI to improve retail decision-making.
              </p>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold">Everything Retailers Need</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl border">
              <h3 className="font-semibold text-xl mb-3">AI Recommendations</h3>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="mt-4 font-semibold">Upload Transactions</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="mt-4 font-semibold">Train MBA Models</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="mt-4 font-semibold">Generate Rules</h3>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="mt-4 font-semibold">Get AI Insights</h3>
            </div>
          </div>
        </div>
      </section>
